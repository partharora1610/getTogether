...
export default function Home() {
  return (
    <>
      <div className="mx-auto mb-4 flex max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50 mt-[10px]">
      ...
      <div className="flex justify-center flex-col items-center">
        ...
        <p className="mt-5 text-center max-w-prose text-zinc-700 sm:text-lg">
          ...
          nobis ipsum atque illo provident, nulla mollitia quas voluptatem
          magnam. Similique quam impedit totam praesentium laboriosam magnam
          iste omnis facere tempore.
        </p>
      </div>

      <div className="flex justify-center items-center">
        <Link
          className="bg-primary-400 text-white flex items-center justify-between p-2 rounded-xl mt-[10px]"
          href="/auth"
          target="_blank"
        >
